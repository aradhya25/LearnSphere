...
export default function TeacherAttemptDetailsModal({
  isOpen,
  onClose,
  attempt = {},
}) {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              <div className="flex items-center space-x-2.5 min-w-0">
                ...
                <div className="min-w-0 leading-none">
                  ...
                  <p className="font-extrabold text-darkGray truncate">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-2.5">
                ...
                <div className="leading-tight">
                  ...
                  <p className="font-extrabold text-darkGray">
                    {attempt.course_title || "—"}
                  </p>
                  <p className="font-medium text-slate-450 mt-0.5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[#F8FAFC]/60 border border-slate-100 p-4 rounded-2xl flex flex-col justify-center items-center text-center">
              ...
              <p className="text-xl font-black text-darkGray mt-1.5 leading-none">
                {attempt.score || 0}
                <span className="text-xs text-slate-350 font-normal">
                  {" "}
